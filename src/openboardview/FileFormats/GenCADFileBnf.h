...
string_with_end     : <string_to_end> <n>+;
arc_start           : <x_y_ref> ;
arc_end             : <x_y_ref> ;
arc_center          : <x_y_ref> ;
arc_p1              : <number> ;
...
artwork_name        : (<nonquoted_string> | <string>);
...
part_name_to_end    : <wrapper_to_end>;
...
sig_name_to_end     : <wrapper_to_end>;
tan                 : <string>;
testpad_name        : <string>;
text_size           : <number>;
text_text           : <string>;
...
y                   : <number> ;
x_y_ref             : <x> <s>+ <y>;
header              : "$HEADER" <n>+ (<gencad_version>|<user>|<drawing>|<revision>|<units>|<origin>|<intertrack>|<attribute>|<string_with_end>)* "$ENDHEADER" <n>*;
major               : <p_integer>;
minor               : <p_integer>;
version             : <major> ("." <minor>)?;
gencad_version      : "GENCAD" (<s>+  <version>)? <n>+;
...
artworks_artwork    : "ARTWORK" <s>+ <artwork_name> <n> (<named_layer>|<track_>|<filled>|<text>|<line>|<arc>|<circle>|<rectangle>|<attribute>|<type>)* <n>*;
...
value               : ("VALUE"|"Value") <s>+ <wrapper_to_end> <s>* <n>+;
partnumber          : "PartNumber" <s> <nonquoted_string> <n>+;
device              : "DEVICE" <s>+ <part_name_to_end> <n>+ (<part>|<type>|<style>|<package>|<pindesc>|<pinfunct>|<pincount>|<value>|<tol>|<ntol>|<ptol>|<volts>|<desc>|<attribute>|<partemp>)* <n>*;
...
signal              : "SIGNAL" <s>+ <sig_name_to_end> <n>* (<node>|<nailloc>|<attribute>)* <n>*;
...
route               : "ROUTE" <s>+ <sig_name_to_end> <n>+ (<track_>|<layer_>|<line>|<arc>|<circle>|<rectangle>|<via>|<testpad>|<plane>|<text>|<attribute>)*;
